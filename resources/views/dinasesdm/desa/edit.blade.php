...
<div class="max-w-3xl mx-auto space-y-6">
    ...
    <div class="bg-white p-6 rounded-3xl shadow-sm border border-slate-200/80">
        ...
        <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight">Edit Data Rasio Elektrifikasi Desa</h2>
        <p class="text-xs text-slate-500 mt-0.5">Perbarui informasi geospasial dan tingkat keterjangkauan desa {{ $desa->nama_desa }}.</p>
    </div>

    <div class="bg-white p-6 sm:p-8 rounded-3xl shadow-sm border border-slate-200/80">
        <form method="POST" action="{{ route('dinasesdm.desa.update', $desa) }}" class="space-y-6">
            @csrf
            @method('PUT')
            ...
            <div class="space-y-5">
                ...
                <div class="space-y-2">
                    ...
                    <input type="text" id="nama_desa" name="nama_desa" value="{{ old('nama_desa', $desa->nama_desa) }}" required
                ...
                <div class="space-y-2">
                    ...
                    <select id="kabupaten" name="kabupaten" required
                        ...
                        <option value="KABUPATEN KERINCI" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN KERINCI' ? 'selected' : '' }}>KABUPATEN KERINCI</option>
                        <option value="KABUPATEN MERANGIN" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN MERANGIN' ? 'selected' : '' }}>KABUPATEN MERANGIN</option>
                        <option value="KABUPATEN SAROLANGUN" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN SAROLANGUN' ? 'selected' : '' }}>KABUPATEN SAROLANGUN</option>
                        <option value="KABUPATEN BATANG HARI" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN BATANG HARI' ? 'selected' : '' }}>KABUPATEN BATANG HARI</option>
                        <option value="KABUPATEN MUARO JAMBI" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN MUARO JAMBI' ? 'selected' : '' }}>KABUPATEN MUARO JAMBI</option>
                        <option value="KABUPATEN TANJUNG JABUNG TIMUR" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN TANJUNG JABUNG TIMUR' ? 'selected' : '' }}>KABUPATEN TANJUNG JABUNG TIMUR</option>
                        <option value="KABUPATEN TANJUNG JABUNG BARAT" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN TANJUNG JABUNG BARAT' ? 'selected' : '' }}>KABUPATEN TANJUNG JABUNG BARAT</option>
                        <option value="KABUPATEN TEBO" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN TEBO' ? 'selected' : '' }}>KABUPATEN TEBO</option>
                        <option value="KABUPATEN BUNGO" {{ old('kabupaten', $desa->kabupaten) == 'KABUPATEN BUNGO' ? 'selected' : '' }}>KABUPATEN BUNGO</option>
                        <option value="KOTA JAMBI" {{ old('kabupaten', $desa->kabupaten) == 'KOTA JAMBI' ? 'selected' : '' }}>KOTA JAMBI</option>
                        <option value="KOTA SUNGAI PENUH" {{ old('kabupaten', $desa->kabupaten) == 'KOTA SUNGAI PENUH' ? 'selected' : '' }}>KOTA SUNGAI PENUH</option>
                    </select>
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="number" step="any" id="latitude" name="latitude" value="{{ old('latitude', $desa->latitude) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" step="any" id="longitude" name="longitude" value="{{ old('longitude', $desa->longitude) }}" required
                ...
                <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div class="space-y-2">
                        ...
                        <input type="number" min="0" id="total_rt" name="total_rt" value="{{ old('total_rt', $desa->total_rt) }}" required
                    ...
                    <div class="space-y-2">
                        ...
                        <input type="number" min="0" id="berlistrik_rt" name="berlistrik_rt" value="{{ old('berlistrik_rt', $desa->berlistrik_rt) }}" required
            ...
            <div class="pt-4 border-t border-slate-100 flex items-center justify-end gap-3">
                ...
                <button type="submit" class="px-6 py-2.5 bg-blue-700 hover:bg-blue-800 text-white font-extrabold text-xs rounded-xl shadow-md shadow-blue-700/25 transition">
                    <i class="fa-solid fa-pen-to-square mr-1"></i> Perbarui Data Desa
                </button>
            </div>
        </form>
    </div>
